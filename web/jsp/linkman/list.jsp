										...
										<TABLE id=grid
											...
											<TBODY>
												...
												<TR
													...
													<TD>
													<a href="${pageContext.request.contextPath }/linkman_delLinkman.do?lkmId=${linkman.lkmGender }">修改</a>
													&nbsp;&nbsp;
													<a href="${pageContext.request.contextPath }/linkman_delLinkman.action?lkmId=${linkman.lkmId }">删除</a>
													</TD>
												</TR>
