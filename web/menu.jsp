...
<TR>
	<TD class=menuSmall><A class=style2 href="${pageContext.request.contextPath }/customer_pageCustomer.action?currentPage=1"
									...
									<TD>
										<TABLE id=table_2 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												...
												<TR>
													<TD class=menuSmall><A class=style2 href="linkman_findLinkmanAll.action"
